# Daily Research Update: 2026-01-21

**상태:** 신규 논문 20편 (과거 수집 데이터 제외 완료)

## 1. THE ECONOMICS OF SPATIAL MOBILITY: THEORY AND EVIDENCE USING SMARTPHONE DATA
...
---
## 2. Evaluating groundwater potential with the synergistic use of geospatial methods and advanced machine learning approaches
...
---
## 3. Geographical Gaussian Process Regression: A Spatial Machine‐Learning Model Based on Spatial Similarity
...
---
## 4. The Modifiable Areal Unit Problem in Political Science
...
---
## 5. A Machine Learning Approach to Analyzing Crime Concentration: The Case of New York City
...
---
## 6. Smart Hotspot Detection Using Geospatial Artificial Intelligence: A Machine Learning Approach to Reduce Flood Risk
...
---
## 7. Evaluating Cooling Effect of Blue-green Infrastructure on Urban Thermal Environment in a Metropolitan City: Using Geospatial and Machine Learning Techniques
...
---
## 8. Investigating the effects of urban morphology on vitality of community life circles using machine learning and geospatial approaches
...
---
## 9. Fear of a Black Neighborhood: Anti-Black Racism and the Health of White Americans.
...
---
## 11. Integrating Data Across Misaligned Spatial Units
...
---
## 12. Modeling Spatial Heterogeneity and Historical Persistence: Nazi Concentration Camps and Contemporary Intolerance
...
---
## 13. Vulnerability in the Neighborhood: A Study of Perceived Control Over Victimization
...
---
## 14. Centring the periphery in urban studies: Notes towards a research agenda on peripheral centralities
...
---
## 15. The spatial (in)stability of mental health calls for police service
...
---
## 16. The spatial dynamics of commercial burglary during the COVID-19 lockdown in San Francisco
...
---
## 17. Down with the sickness? Los Angeles burglary and COVID-19 restrictions
...
---
## 18. Paws on the Street: Neighborhood-Level Concentration of Households with Dogs and Urban Crime
...
---
## 19. From Residential Neighborhood to Activity Space: The Effects of Educational Segregation on Crime and Their Moderation by Social Context
...
---
## 20. A more global urban studies, besides empirical variation
- **Authors:** Julie Ren
- **Journal:** Urban studies
- **Date:** 2022-04-01
